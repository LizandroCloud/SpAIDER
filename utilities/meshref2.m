function [tkk wkk ns_ref point] = meshref(Pgrad,ns,ic,ts_a,w02,t0,tf,wfact)
...
%                       end
                    ...
                    w_ref(ic,jj+1)=w02(ic,j);
                         ...
                         B = abs(w02(j+1) - w02(j));
                           ...
                           if A>B wfact=w_medium; % w_upper;
                           else wfact=w_medium; end % w_lower;
