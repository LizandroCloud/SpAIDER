function [cfd,detais0,maxlev,C,L] = wav_mesh(wopt,is,ic,wname)
 % ************************************************************************
 ...
 %*************************************************************************
maxlev = wmaxlev(length(wopt(end,:)),wname); % maximum level of wavelet resolution 
%    wopt1 = wopt*2^(-maxlev/2);
[C,L] = wavedec(wopt(end,:),maxlev,wname);  % C are wavelets coefficients
