function [ f, t_ult, t_out, y, df ] = fun( x0, ns, ts, ws, ne, n_s,n_c,w_froz,check,ns_a,frozen,is,is0,w0,ts_frozen,solver,optODE,typ,reg,est,optSPAIDER )
...
if nargout ~= 5 % Forward state integration with numerical jacobian...
