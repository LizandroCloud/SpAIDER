...
function [r0 tstat fstat] = g_state(plot_state,nss,tss,wopt,ns,x0,nUt,w_frozen,check,ns_a,frozen,is,is0,w0,ts_frozen,solver,optODE,typ,f,t0,tf,tf_p,talf,reg,est,optSPAIDER)
 % ************************************************************************
...
% if plot_state==1  % plotting only in this case
     if is>=is0 % only for upper iterations
        % calling integration
