...
function [r0 tstat fstat] = g_state(plot_state,nss,tss,wopt,ns,x0,nUt,w_frozen,check,ns_a,frozen,is,is0,w0,ts_frozen,solver,optODE,typ,f,t0,tf,tf_p,talf,reg,est,wLL, wUU, optSPAIDER)
...
%             function_ode( x0, ns, ts, ws, ne, n_s,      n_c,w_froz,  check,ns_a,frozen,is,is0,w0,ts_frozen,solver,optODE,typ,reg,est,optSPAIDER )
